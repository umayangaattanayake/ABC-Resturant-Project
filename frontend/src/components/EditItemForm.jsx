...
const ItemEditForm = ({ onClose }) => {
  ...
  const handleAddItem = async () => {
    ...
    if (ok) {
      ...
      setValue("AlertMessage", "an error occured!");
      setValue("AlertVisibility", true);
  ...
  const handleUpdateItem = async () => {
    ...
    if (ok) {
      setValue("AlertType", "primary");
      setValue("AlertMessage", "item updateded successfully!");
      setValue("AlertVisibility", true);
  ...
  const handleImageChange = async (event) => {
    ...
    if (ok) {
      ...
      // Construct the image URL using the API URL and uploaded filename
      ...
      case "Product":
        return (
          <>
            ...
            <div className="mb-3">
              <label htmlFor="status-r" className="form-label">
                Status
              </label>
              <select
      ...
      case "Service":
        return (
          <>
            ...
            {/* Add category dropdown for Services */}
            <div className="mb-3">
              <label htmlFor="category" className="form-label">
                Category
              </label>
      ...
      case "Offer":
        return (
          <>
            ...
            {/* Add product dropdown for Offers */}
            <div className="mb-3">
